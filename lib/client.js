  ...
  factory: (require) => {
    ...
    var dict = {
      zh: {
        ...
        // 用户管理
        users: '用户管理', addUser: '新增用户', usernameLabel: '用户名', emailLabel: '邮箱',
      ...
      en: {
        ...
        users: 'Users', addUser: 'Add user', usernameLabel: 'Username', emailLabel: 'Email',
    ...
    function UsersSection() {
      ...
      function load() {
        mt('user.list', {}).then(function (v) { setList(v.users); setError(null); })
      ...
      function createUser() {
        setBusy(true); setMsg(null); setError(null);
        mt('user.create', { username: form.username, email: form.email || null, password: form.password, role: form.role || 'user' })
